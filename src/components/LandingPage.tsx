...
import { Shield, Clock, MapPin, Phone, Users, Heart, CheckCircle, ArrowRight, Zap } from 'lucide-react';
...
export function LandingPage() {
  ...
  const handleContratarClick = () => {
    alert('Funcionalidade em desenvolvimento - Configure o Supabase para ativar todas as funcionalidades');
  };
